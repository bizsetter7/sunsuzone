                ...
                <div className="max-w-[640px] mx-auto pointer-events-auto">
                    ...
                    <div className="flex flex-row gap-2 p-3">
                        ...
                        <button
                            ...
                            className="flex-[2] py-3 bg-[#D4AF37] text-slate-900 font-black text-xs md:text-sm rounded-2xl flex items-center justify-center gap-1.5 shadow-xl shadow-amber-900/20 active:scale-[0.98] transition-all hover:bg-[#b8922e] whitespace-nowrap"
                        >
