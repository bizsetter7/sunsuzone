        ...
        <div className={`space-y-6 animate-in fade-in slide-in-from-right-4 duration-500 pb-20`}>
            ...
            <div className={`p-6 rounded-[32px] border shadow-sm ${brand.theme === 'dark' ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-100'}`}>
                ...
                <div className="mt-8 flex justify-center gap-3">
                    ...
                    <button onClick={handleSaveResume} className="px-8 py-3 rounded-xl bg-[#D4AF37] text-slate-900 font-black hover:bg-[#b8922e] transition shadow-lg active:scale-95 whitespace-nowrap">이력서 등록완료</button>
                </div>
            </div>
        </div>
    );
