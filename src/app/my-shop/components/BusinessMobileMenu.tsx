                ...
                <div className="pb-4 border-b border-gray-100 dark:border-gray-800">
                    <div className="flex items-center justify-between gap-2 mb-2">
                        ...
                        <button
                            ...
                            className={`p-2.5 rounded-xl border shrink-0 transition-all ${brand.theme === 'dark' ? 'bg-gray-800 border-gray-700 text-gray-400 hover:text-[#D4AF37]' : 'bg-gray-50 border-gray-100 text-gray-400 hover:bg-amber-50 hover:text-[#D4AF37] hover:border-amber-100'}`}
                            title="로그아웃"
                        >
                            <LogOut size={16} />
                        </button>
