    ...
    return createPortal(
        <div className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4" style={{ zIndex: UI_Z_INDEX.MODAL }}>
            <div className="bg-white rounded-[28px] shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                {/* Header */}
                <div className="bg-[#D4AF37] px-6 py-5 text-white text-center">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-center">
                        <p className="text-xs font-bold text-[#D4AF37] mb-1">입금 금액</p>
                        <p className="text-3xl font-black text-[#D4AF37]">{amount.toLocaleString()}원</p>
                    </div>
                ...
                <div className="px-6 pb-6">
                    <button
                        onClick={onConfirm}
                        className="w-full py-4 bg-[#D4AF37] text-white font-black text-base rounded-2xl shadow-lg hover:brightness-110 active:scale-[0.98] transition-all"
                    >
                        확인
                    </button>
                </div>
