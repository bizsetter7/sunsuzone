        ...
        <div className="min-h-screen bg-white flex flex-col font-sans">
            <main className="flex-1 max-w-6xl mx-auto px-4 md:px-8 py-10 md:py-16">
                <div className="text-center mb-10 md:mb-14">
                    <span className="inline-block px-4 py-1.5 bg-amber-50 text-[#D4AF37] rounded-full text-[10px] md:text-xs font-black uppercase tracking-[0.2em] mb-4">
                        STEP BY STEP GUIDE
                    </span>
                    ...
                    <div className="relative group bg-white rounded-[28px] p-7 border-2 border-amber-400 shadow-[0_10px_30px_-15px_rgba(251,191,36,0.12)] transition-all hover:-translate-y-1">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-slate-600 text-xs md:text-sm leading-relaxed break-keep font-bold opacity-90">
                                <strong className="text-[#D4AF37]">1개월 결제 시 1개월 추가 무료!</strong><br />지금 신청하면 총 2개월을 경험하세요.
                    ...
                    <div className="relative group bg-amber-50/10 rounded-[28px] p-7 border-2 border-dashed border-amber-200 shadow-[0_10px_30px_-15px_rgba(248,43,96,0.08)] transition-all hover:-translate-y-1">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <div className="text-slate-600 text-xs md:text-sm leading-relaxed break-keep font-bold opacity-90">
                                ...
                                <div className="mt-4">
                                    <span className="text-[9px] text-[#D4AF37] font-black uppercase tracking-widest bg-amber-100/50 py-1.5 px-3 rounded-full inline-block">Recommended Ad System</span>
                                </div>
                            </div>
                        </div>
                    </div>
