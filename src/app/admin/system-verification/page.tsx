                                    ...
                                    filteredShops.map(shop => {
                                        ...
                                        return (
                                            <tr key={shop.id} className={`hover:bg-gray-50 transition ${isIssue ? 'bg-red-50/30' : ''}`}>
                                                ...
                                                <td className="p-3">
                                                    <a href={`/sunsu/${slugify(shop.region)}/${shop.id}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-xs font-bold text-gray-600 hover:bg-gray-50 hover:text-blue-600 transition">
