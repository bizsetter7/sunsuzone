        ...
        <>
            ...
            {!isExpanded && userType === 'corporate' && (
                <button
                    ...
                    className={`absolute bottom-4 left-1/2 -translate-x-1/2 w-14 h-14 rounded-full bg-gradient-to-r from-blue-500 to-amber-400 shadow-lg shadow-blue-500/30 flex items-center justify-center pointer-events-auto hover:scale-105 transition-transform`}
                        ...
                        {navItems.map((item, index) => {
                            ...
                            if (item.isMain) {
                                return (
                                    ...
                                    >
                                        <div className="w-14 h-14 rounded-full bg-gradient-to-r from-blue-500 to-amber-400 shadow-lg shadow-blue-500/30 flex items-center justify-center hover:scale-105 transition-transform">
                                            {item.icon}
                                        </div>
                            ...
                            if (item.href === '/my-shop') {
                                return (
                                    ...
                                    >
                                        <div className={isActive ? 'text-[#D4AF37]' : ''}>
                                            {item.icon}
                                        </div>
