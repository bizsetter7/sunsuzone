...
const POPULAR_REGIONS = [
    { label: '강남 알바', href: '/sunsu/서울-강남구' },
    { label: '논현동 알바', href: '/sunsu/서울-강남구-논현동' },
    { label: '여의도 알바', href: '/sunsu/서울-영등포구-여의도동' },
    { label: '수원 인계동 야간알바', href: '/sunsu/경기-수원시-인계동' },
    { label: '부천 상동 알바', href: '/sunsu/경기-부천시-상동' },
    { label: '부산 서면 알바', href: '/sunsu/부산-부산진구' },
    { label: '해운대 알바', href: '/sunsu/부산-해운대구' },
    { label: '인천 계양구 알바', href: '/sunsu/인천-계양구' },
    { label: '대전 유성 알바', href: '/sunsu/대전-유성구' },
    { label: '대구 수성구 알바', href: '/sunsu/대구-수성구' },
    { label: '광주 상무지구 알바', href: '/sunsu/광주-서구' },
];
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-x-8 gap-y-3.5 max-w-4xl mx-auto">
                                {POPULAR_REGIONS.map((region) => (
                                    <Link
                                        key={region.href}
                                        href={region.href}
                                        className="text-[11.5px] md:text-[12.5px] text-gray-500 hover:text-[#D4AF37] hover:font-bold transition-all whitespace-nowrap"
                                    >
                                        {region.label}
                                    </Link>
                                ))}
                                <Link
                                    href="/region/all"
                                    className="text-[11.5px] md:text-[12.5px] font-black text-[#D4AF37] hover:underline flex items-center justify-center"
                                >
                                    더보기 +
                                </Link>
                            </div>
