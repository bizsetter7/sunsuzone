                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            {userRole === 'admin' && (
                                <div className="space-y-1">
                                    ...
                                    <button onClick={() => { router.push('/admin'); setShowMobileMenu(false); }} className="w-full text-left py-3 px-4 rounded-xl font-black text-[#D4AF37] bg-rose-50/50 flex items-center gap-2">
                                ...
                                <div className="space-y-1">
                                    {CATEGORIES.map((cat) => (
                                        <button
                                            ...
                                            className={`w-full text-left py-3 px-4 rounded-xl font-bold ${searchParams.get('category') === cat.name || (!searchParams.get('category') && cat.name === '전체') ? 'bg-rose-50 text-[#D4AF37]' : 'text-gray-600'}`}
                                        >
                                            {cat.name}
                                        </button>
                                    ))}
                                ...
                                <div className="space-y-1">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`w-full text-left py-3 px-4 rounded-xl font-bold ${(searchParams.get('tab') === item.id || (page === 'support' && item.id === 'notice') || page === item.id) ? 'bg-rose-50 text-[#D4AF37]' : 'text-gray-600'}`}
                                        >
                                            {item.label}
                                        </button>
                                    ))}
