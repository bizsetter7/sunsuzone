...
export const JobDetailContent = ({
    ...
    const getHeaderTheme = (tid: string) => {
        switch (tid) {
            ...
            case 'p2':     return { bg: "from-red-500 to-amber-600",                   accent: "text-red-600",     badge: "bg-white/20" }; // Premium
        ...
        >
            ...
            <div className="px-4 py-2 md:py-3 bg-white border-t border-gray-100 grid grid-cols-4 gap-2 shrink-0 safe-area-bottom">
                ...
                <button
                    ...
                    className="col-span-2 py-2 md:py-3 bg-[#D4AF37] text-white rounded-2xl flex items-center justify-center gap-2 hover:bg-[#b8922e] transition shadow-lg shadow-[#D4AF37]/30 group"
                >
