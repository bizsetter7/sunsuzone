        ...
        <>
            <div className={`flex flex-col gap-2 w-full pt-0`}>
                <div className="flex flex-col gap-2 pb-4">
                    ...
                    <div
                        onClick={() => router.push('/customer-center?tab=inquiry')}
                        className={`p-2 border rounded-[18px] shadow-md text-center mx-1 border-b-2 border-b-amber-500/20 active:scale-95 transition-transform cursor-pointer ${contactBoxClass}`}
                    >
                        <p className="text-[10px] text-amber-500 font-extrabold mb-0.5">광고입점상담</p>
