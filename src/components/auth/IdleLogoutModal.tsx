        ...
        <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-[340px] bg-white dark:bg-slate-900 rounded-[28px] overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] border border-slate-200/50 dark:border-slate-800/50 animate-in zoom-in-95 fade-in duration-300">
                ...
                <div className="p-6 pb-0 flex flex-col items-center text-center">
                    <div className="w-16 h-16 rounded-full bg-amber-50 dark:bg-amber-900/20 flex items-center justify-center mb-4 relative">
                        <Clock size={32} className="text-[#D4AF37] animate-pulse" />
                        <div className="absolute inset-0 rounded-full border-4 border-[#D4AF37]/20 border-t-[#D4AF37] animate-spin" style={{ animationDuration: '3s' }} />
                    </div>
                    ...
                    <p className="text-sm font-medium text-slate-500 dark:text-slate-400 leading-relaxed px-2">
                        장시간 활동이 감지되지 않아<br />
                        <span className="font-black text-[#D4AF37] underline underline-offset-4 decoration-2">자동 로그아웃</span>될 예정입니다.
                    </p>
                </div>
                ...
                <div className="p-6 flex flex-col gap-2">
                    ...
                    <button
                        onClick={onLogout}
                        className="w-full h-12 bg-transparent text-slate-400 dark:text-slate-500 hover:text-[#D4AF37] font-bold text-sm flex items-center justify-center gap-1 transition-colors"
                    >
                        <LogOut size={16} />
                        즉시 로그아웃
                    </button>
